...
var didScroll = false;window.onscroll = () => didScroll = true;setTimeout(() => {if (!didScroll) {window.scrollTo({ top: 1, behavior: 'smooth' })}},5000);
...
$('.avatar-image-container img').attr('src', function($this, i) {
	i = i.replace('//resources.blogblog.com/img/blank.gif', 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhrES9AHwtLpe2aAbgx4hMR4uW6DEkP_MQdPU3N0eadYwOEUrPtSfqf_lXoZHY7hRiQ0rUnhhEoiho2YQ2TLwPSPN-mITlB6IbC7x60mGMgTvf886N6UeP7m6qnJ-157TKmbk9iaf9l0uU/s35-r/avatar.jpg');
	i = i.replace('//img1.blogblog.com/img/blank.gif', 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhrES9AHwtLpe2aAbgx4hMR4uW6DEkP_MQdPU3N0eadYwOEUrPtSfqf_lXoZHY7hRiQ0rUnhhEoiho2YQ2TLwPSPN-mITlB6IbC7x60mGMgTvf886N6UeP7m6qnJ-157TKmbk9iaf9l0uU/s35-r/avatar.jpg');
	return i
});
...
function getPostComments(feed, i, link) {
	...
	if (e.match('//img1.blogblog.com/img/blank.gif') || e.match('//img1.blogblog.com/img/b16-rounded.gif')) {
		var img = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhrES9AHwtLpe2aAbgx4hMR4uW6DEkP_MQdPU3N0eadYwOEUrPtSfqf_lXoZHY7hRiQ0rUnhhEoiho2YQ2TLwPSPN-mITlB6IbC7x60mGMgTvf886N6UeP7m6qnJ-157TKmbk9iaf9l0uU/w55-h55-p-k-no-nu/avatar.jpg'
	} else {
		var img = e
	}
...
$('i[rel="pre"]').replaceWith(function() {
	return $('<pre><code>' + $(this).html() + '</code></pre>');
       ...
       const navBar = document.querySelector(".navbar");const allLi = document.querySelectorAll(".navbar li");
            ...
            success: function (t) {
                for (var u = "", h = '<div class="related">', x = 0; x < t.feed.entry.length; x++) {
                    ...
                    if (c.indexOf("https://www.youtube.com/embed/") > -1 || c.indexOf("https://www.youtube.com/embed/") > -1) {
                        ...
                        var k = 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjvBjt-YJy9pofAJI5cnKXLGHP-jkOW1MAqcM6wPWO5yx-4TkWrDhZlUqNazzii-wyBt7KJA-HCAOYelo49Y2r_w1T29As1R3dhbo6ag2aqomM-0RX3soPbbY_hZVXon2R7HbgOz6n_hn0m/s1600/noImage.png';
                    }
...
setInterval(function() {if(console.clear) {console.clear();}}, 10);
...
var aG=new DOMParser,aH=$("#blogger-components"),aI=aH.is("textarea")?aH.val():aH.html(),aJ=aG.parseFromString(aI,"text/html");$(window).one("scroll",function(){if($(".widget.Blog").length>0&&$(window).scrollTop()+$(window).height()>$(".widget.Blog").offset().top&&1!=$("body").attr("data-tempjs")){$("body").attr("data-tempjs",!0);var aL=$(aJ.head).find('script[src*="cookienotice.js"]');aL.length>0&&$.getScript(aL.attr("src"),function(){var aM="";$.each($(aJ.head).find("script:not([src]):first").html().match(/(\(window|window).*/g),function(t,e){aM+=e}),eval(aM)}),$.getScript($(aJ.head).find('script[src*="widgets.js"]').attr("src"),function(){eval($(aJ.head).find("script:not([src]):last").html()),o=_WidgetManager._GetAllData().blog.blogId})}})//]]>
